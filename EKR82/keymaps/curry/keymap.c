...
#define LAYOUT_EKR82_base_wrapper(...) LAYOUT_EKR82_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_EKR82_base_wrapper(
    ...
    [_COLEMAK] = LAYOUT_EKR82_base_wrapper(
        ________________NUMBER_LEFT________________, ________________NUMBER_RIGHT_______________,
    ...
    [_DVORAK] = LAYOUT_EKR82_base_wrapper(
        ________________NUMBER_LEFT________________, ________________NUMBER_RIGHT_______________,
